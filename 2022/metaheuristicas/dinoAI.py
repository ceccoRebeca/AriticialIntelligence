...
def generate_neighborhood(state):
    ...
    for i in range(state_size):
        ...
        dd = random.randint(1, 50)
        new_states = [change_state(state,i,ds,0), change_state(state,i,(-ds),0), change_state(state,i,0,dd), change_state(state,i,0,(-dd))]
        for s in new_states:
           if s != []:
...
def main():
  ...
  initial_state = [(23,300), (50,400), (60,500), (1000, 600)]
